...
class HelloForm(Form):
    ...
    def __init__(self, owner):
        self.SetProps(Caption = "Hello Python", Position = "poScreenCenter", OnShow = self.__form_show)

        self.hello = Label(self)
        self.hello.SetProps(Parent = self, Text = "Hello Python from Delphi FMX", Position = Position(PointF(20, 20)))

        self.clickme = Button(self)
        self.clickme.SetProps(Parent = self, Text = "Click Me", Position = Position(PointF(20, 50)), OnClick = self.__button_click)
